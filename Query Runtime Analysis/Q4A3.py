...
for q in range(0, 50):
    ...
    Uni_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
...
for q in range(0, 50):
    ...
    self_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    User_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
print("SmallDB Uninformed Query Average Runtime: ", S_user_time)
...
for q in range(0, 50):
    ...
    M_Uni_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    M_self_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    M_User_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    L_Uni_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    L_self_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
...
for q in range(0, 50):
    ...
    L_User_q = c.execute('''SELECT COUNT( DISTINCT(S.seller_postal_code))
                        FROM Sellers S, Orders O, Order_items Oi
                        WHERE O.customer_id = (SELECT DISTINCT O.customer_id
                            FROM Orders O, Order_items Oi
                            WHERE O.order_id = Oi.order_id
