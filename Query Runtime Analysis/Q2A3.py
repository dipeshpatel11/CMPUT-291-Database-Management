...
def query():
    global conn, c
    # creating view
    c.execute('''CREATE VIEW OrderSize(oid,size)
                    AS SELECT O.order_id, COUNT(OI.order_item_id)
